...
st.set_page_config(page_title="AI短剧分镜【一键分集复制版】", page_icon="🎬", layout="wide")
    ...
    if not user_input:
        ...
        if full_content:
            ...
            for index, ep in enumerate(episodes):
                clean_ep = ep.strip()
                if clean_ep and len(clean_ep) > 50: # 过滤掉掉太短的杂质
                    # 尝试抓取标题
                    ...
                    with st.container(border=True):
                        ...
                        # 【核心一键复制框】
                        st.write(f"👇 请点击下方黑框右上角的【复制】图标 (无需手动选中文字)：")
